...
const Contact = () => {
  // Coordinates for the center of your country (example uses Singapore)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Contact Us | Cleaning Haul</title>
        <meta name="description" content="Get in touch with Cleaning Haul for all your cleaning service needs" />
      </Helmet>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-base text-gray-600">
                  ...
                  <p>info@cleaninghaul.com</p>
                  <p>support@cleaninghaul.com</p>
                </div>
              </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
              <iframe
                title="Cleaning Haul Office Location"
                width="100%"
                height="400"
                frameBorder="0"
                scrolling="no"
